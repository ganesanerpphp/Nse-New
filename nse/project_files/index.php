...
while ( $row_country = mysql_fetch_array ( $result_country ) ) {
    ...
    array_push($country_array,$company_name);
...
<div class="header">
  ...
  <div class="header-right">
    ...
    <a href="site_logout.php">Log Out</a>
  </div>
</div>
...
<form autocomplete="off" action="">
  <div class="autocomplete" style="width:300px;">
    <input id="company_name" type="text" name="company_name" placeholder="Company">
  </div>
  <input type="button" onclick="call_company_details();" value="Search">
</form>
...
autocomplete(document.getElementById("company_name"), countries);
